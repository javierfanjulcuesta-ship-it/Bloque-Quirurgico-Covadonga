...
import { DEMO_GESTION_CITAS_STORAGE_KEY } from "./demoGestionCitasState";
import { DEMO_OUTGOING_MAIL_STORAGE_KEY } from "./demoOutgoingMail";
...
export const DEMO_LOCAL_STORAGE_KEYS = [
  ...
  DEMO_GESTION_CITAS_STORAGE_KEY,
  DEMO_OUTGOING_MAIL_STORAGE_KEY,
 ...
 * asignaciones de anestesistas, no disponibilidad, cierres de slots, estado de Gestión de citas,
 * correo simulado y auditoría DEMO en estado vacío. La app queda usable: el usuario debe volver a
 * la pantalla de selección de usuario y elegir un usuario para entrar de nuevo.
 */
